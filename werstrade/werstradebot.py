"""
werstrade is the main module of this bot. It contains the class werstrade()
"""
import copy
import logging
import traceback
...
from werstrade import __version__, constants
from werstrade.configuration import validate_config_consistency
from werstrade.constants import LongShort
from werstrade.data.converter import order_book_to_dataframe
from werstrade.data.dataprovider import DataProvider
from werstrade.edge import Edge
from werstrade.enums import (ExitCheckTuple, ExitType, RPCMessageType, RunMode, SignalDirection,
                             State, TradingMode)
from werstrade.exceptions import (DependencyException, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, PricingError)
from werstrade.exchange import timeframe_to_minutes, timeframe_to_seconds
from werstrade.misc import safe_value_fallback, safe_value_fallback2
from werstrade.mixins import LoggingMixin
from werstrade.persistence import Order, PairLocks, Trade, cleanup_db, init_db
from werstrade.plugins.pairlistmanager import PairListManager
from werstrade.plugins.protectionmanager import ProtectionManager
from werstrade.resolvers import ExchangeResolver, StrategyResolver
from werstrade.rpc import RPCManager
from werstrade.strategy.interface import IStrategy
from werstrade.strategy.strategy_wrapper import strategy_safe_wrapper
from werstrade.wallets import Wallets


logger = logging.getLogger(__name__)


class werstradeBot(LoggingMixin):
    """
    werstrade is the main class of the bot.
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        logger.info('Starting werstrade %s', __version__)
        ...
        # initialization, even before werstradebot has a chance to start its throttling,
        # so anything in the werstradebot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, werstrade my try to recreate stoploss_on_exchange orders
